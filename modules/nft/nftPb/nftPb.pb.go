...
func (x *AddNftWishlistReq) Reset() {
	*x = AddNftWishlistReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_nft_nftPb_nftPb_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AddNftWishlistReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddNftWishlistReq) ProtoMessage() {}

func (x *AddNftWishlistReq) ProtoReflect() protoreflect.Message {
	mi := &file_modules_nft_nftPb_nftPb_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddNftWishlistReq.ProtoReflect.Descriptor instead.
func (*AddNftWishlistReq) Descriptor() ([]byte, []int) {
	return file_modules_nft_nftPb_nftPb_proto_rawDescGZIP(), []int{3}
}

func (x *AddNftWishlistReq) GetNftId() string {
	if x != nil {
		return x.NftId
	}
	return ""
...
func (x *AddNftWishlistRes) Reset() {
	*x = AddNftWishlistRes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_modules_nft_nftPb_nftPb_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AddNftWishlistRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddNftWishlistRes) ProtoMessage() {}

func (x *AddNftWishlistRes) ProtoReflect() protoreflect.Message {
	mi := &file_modules_nft_nftPb_nftPb_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddNftWishlistRes.ProtoReflect.Descriptor instead.
func (*AddNftWishlistRes) Descriptor() ([]byte, []int) {
	return file_modules_nft_nftPb_nftPb_proto_rawDescGZIP(), []int{4}
}

func (x *AddNftWishlistRes) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_modules_nft_nftPb_nftPb_proto_rawDesc = []byte{
	...
	,
...
var file_modules_nft_nftPb_nftPb_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_modules_nft_nftPb_nftPb_proto_goTypes = []interface{}{
	...
	(*Nft)(nil),               // 2: Nft
	(*AddNftWishlistReq)(nil), // 3: AddNftWishlistReq
	(*AddNftWishlistRes)(nil), // 4: AddNftWishlistRes
}
var file_modules_nft_nftPb_nftPb_proto_depIdxs = []int32{
	...
	3, // 2: NftGrpcService.AddNftWishlist:input_type -> AddNftWishlistReq
	1, // 3: NftGrpcService.FindNftsInIds:output_type -> FindNftsInIdsRes
	4, // 4: NftGrpcService.AddNftWishlist:output_type -> AddNftWishlistRes
...
func file_modules_nft_nftPb_nftPb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_modules_nft_nftPb_nftPb_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AddNftWishlistReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_modules_nft_nftPb_nftPb_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AddNftWishlistRes); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
